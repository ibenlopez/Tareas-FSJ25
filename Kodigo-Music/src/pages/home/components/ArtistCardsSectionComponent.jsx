...
import '../../../assets/css/components/ArtistCardsSectionComponent.css'

function ArtistCardsSectionComponent({dataSection}) {
    ...
    <>
      {
        <div className="artist-cards-container" >
          <section className="artist-header-cards-container">
            {/* Validamos que el header exista */}
            <h2 className="artist-header-cards">{dataSection.header || "Sin título"}</h2>

            {/* Botón para mostrar/ocultar tarjetas */}

            {
              dataSection.cards.length > cardsPerRow ?
                <button className="toggle-button-artist-cards" onClick={toggleShowAll}>
...
export default ArtistCardsSectionComponent